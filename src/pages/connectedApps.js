                        ...
                        <tr key={app.companytitle}>
                          <td className="whitespace-nowrap py-4 pr-3 text-sm pl-6">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                <div className="font-medium text-gray-900">{app.companytitle}</div>
                                <div className="text-gray-500">{app.companydesc}</div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="whitespace-nowrap py-4 text-sm text-gray-500">
                            <div className="table-desc">{app.abouttitle}</div>
                          ...
                          <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <a href="#" className="text-indigo-600 hover:text-indigo-900">
                              Edit<span className="sr-only">, {app.companytitle}</span>
                            </a>
                          </td>
                        </tr>
                      ))}
