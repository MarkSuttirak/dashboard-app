    ...
    <>
      ...
      <div className="page-section">
        <div className="dashboard-settings">
          ...
          <HeaderIntegration title="Apps"/>

        </div>

        <div className='dashboard-settings'>
          <div className='rounded-[16px]' style={{ boxShadow: '0px 4px 70px 0px #72727240' }}>
        ...
        <div className='dashboard-settings mt-[60px] flex gap-[14px]'>
        ...
        <div className='dashboard-settings mt-[27px]'>
          <div className='rounded-[16px]' style={{ boxShadow: '0px 4px 70px 0px #72727240' }}>
        ...
        <div className='dashboard-settings mt-[60px] flex items-center'>
