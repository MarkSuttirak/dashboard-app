                ...
                <div className="mt-12">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 grid-cols-1 rounded-xl gap-x-[21px] gap-y-[32px] started-guide">
                        {startupGuide.map((info) => (
                            <div key={info.id} className="w-full sm:w-full rounded-lg mt-2 flex">
          ...
          <div className="mt-12 mb-44">
            ...
            <div className="mx-auto pb-10 grid grid-cols-1 gap-x-4 grid grid-cols-1 gap-4 lg:grid-cols-3 blog-sec">
              {blogs.map((info) => (
                <div
                  key={info.title}
                  className="relative flex items-center space-x-3 bg-white p-6 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400 w-full" style={{background:"url(" + info.background + ")",backgroundSize:"100%",backgroundRepeat:"no-repeat",borderRadius:"20px"}}
                >
