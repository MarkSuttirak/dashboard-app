  ...
  const selectMenu = (val) => {
    switch (val){
      ...
      case 3:
        ...
        break
      case 4:
        setData({image:inbioBg, title:(<>Connect with <span className="text-[#FF4A00]">MarketConnect</span> across All Sales Channels.</>), desc:'Efficiently manage orders regardless of the number of sales channels.', require_pro_text:'Coming soon', link:'', privilege:appPrivileges.marketConnectApp})
        break
      case 5:
        ...
        break
      case 6:
        setData({image:posBg, title:(<><span className="text-[#013395]">POS in.store</span> : store management</>),desc:'Access exclusive tools to help you build client sites and scale your business', require_pro_text:'Upgrade pro plan to use this feature', link:'', privilege:appPrivileges.posApp});
        break
      default:
